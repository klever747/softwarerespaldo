            ...
            <div class="container-fluid">                
                ...
                <div class="card card-default" id="soloLectura">
                    <div class="card-header">
                        <h3 class="card-title">Listado de Ordenes Shopify</h3>
                    ...
                    <?= filtroBusqueda("shopify/ordenes", array("rango_busqueda" => $rango_busqueda, "tipo_calendario" => $tipo_calendario, "uso_calendario" => 0, "order_number" => $order_number, "texto_busqueda" => $texto_busqueda, "store_id" => $store_id, "sel_store" => $sel_store, "regpp" => $regpp)); ?>
...
//                            }
                                ...
                                echo '<div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 ' . $item_row_count . '">';
                                print_r($orden->card);
                                echo '</div>';
