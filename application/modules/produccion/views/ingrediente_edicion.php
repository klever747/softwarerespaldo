<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel"><span id="modal_edicion_master">Ingrediente</span></h5>
...
<div class="modal-body">
    <?php
    $fields = array();
    foreach ($ingrediente as $field => $value) {
    ...
    $fields['longitud']['tipo'] = 'number';
    $fields['tipo']['tipo'] = 'select';
    $fields['tipo']['sel'] = array("T" => 'Tinturado', "N" => 'Natural', "ASS" => 'Assemble');
    $fields['estado']['tipo'] = 'select';
    $fields['estado']['sel'] = array(ESTADO_ACTIVO => 'Activo', ESTADO_INACTIVO => 'Inactivo');
    ?>
    <?= form_open(base_url() . "produccion/Ingrediente/ingrediente_guardar", array("id" => "form_modal_edicion")); ?>
...
<div class="modal-footer">
    ...
    <script>
        ...
        function recargarProducto() {
            loadProducto(<?= isset($ingrediente->id) ? $ingrediente->id : 0 ?>);
        }
