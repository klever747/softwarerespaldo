    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Reporte de Ventas por SKU</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                            <li class="breadcrumb-item">Producci&oacute;n</li>
                            <li class="breadcrumb-item">Reporte de Ventas Por SKU</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                                            ...
                                                            foreach ($caja[$t]['longitud'] as $longitud => $value) {
                                                                foreach ($caja[$t]['longitud'][$longitud]['tallos'] as $stemsXcaja => $valor_stem) {
                                                                    foreach ($caja[$t]['longitud'][$longitud]['tallos'][$stemsXcaja]['precios'] as $precioxstem => $precio) {
                                                                        $id_div = $caja['alias']."_".reemplazarPunto($longitud, "-")."_".($precioxstem >= 0 ? reemplazarPunto($precioxstem, "m") :reemplazarPunto($precioxstem, "m"))."_".$caja['finca_id']."_".$caja['tipo_caja_id']."_".$t;
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#exportar_excel").on('click', function () {
            ...
            window.open('<?= base_url() ?>produccion/reportes/resumen_cajas_precio_sku_xls?finca_id='+finca_id+'&filtro=' + JSON.stringify(filtroActual), '_blank');
        });
        ...
        $(document).on('click', '.mostrar_ordenes_id', function (e) {
            ...
            llamadaAjax(false, '<?= base_url() ?>produccion/Reportes/json_buscar_ordenes', { "finca_id":finca_id,"session_finca":session_finca,"filtro": filtroActual,"parametro_buscar": parametro_buscar},agregarInformacion);
