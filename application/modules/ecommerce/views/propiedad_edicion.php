...
<div class="modal-body">
    ...
    <?php
    $fields = array();
    foreach ($propiedad as $field => $value) {
...
//    $fields['store_id']['sel'] = $sel_store;
    ...
    ?>
    <?= form_open(base_url() . "ecommerce/producto/propiedad_guardar", array("id" => "form_modal_edicion")); ?>
...
<div class="modal-footer">
    ...
    <script>
        ...
        function recargarPropiedad() {
            loadPropiedad(<?= isset($propiedad->id) ? $propiedad->id : 0 ?>);
        }
