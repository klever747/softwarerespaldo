<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel"><span id="modal_edicion_master">Tienda</span></h5>
...
<div class="modal-body">
    ...
    ?>
    <?= form_open(base_url() . "ecommerce/store/tienda_guardar", array("id" => "form_modal_edicion")); ?>
